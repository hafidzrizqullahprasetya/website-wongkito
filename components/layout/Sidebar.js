                    ...
                    <div className="flex items-center justify-between p-6 !bg-wk-maroon">
                        <Link href="/" className="flex items-center">
                            ...
                            <div className="ml-3 flex flex-col justify-center">
                                <span className="text-white font-extrabold text-[11px] sm:text-xs leading-[1.1] tracking-tight whitespace-nowrap">
                                    Pempek <span className="font-dancing text-wk-gold italic text-xs sm:text-base mx-0.5">"Asli"</span>
